...
features_train = pd.read_csv("files/datasets/intermediate/a08_features_train_downsampled.csv")
target_train = pd.read_csv("files/datasets/intermediate/a08_target_train_downsampled.csv")
...
lr_downsampled = LogisticRegression(**best_params_lr)
lr_downsampled.fit(features_train, target_train)

# Save the best model ----------------------------------------

joblib.dump(lr_downsampled,
        f"files/modeling_output/model_fit/b04_lr_downsampled.joblib"
        )